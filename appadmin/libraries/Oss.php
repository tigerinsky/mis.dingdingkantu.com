...
class Oss {
    ...
    private $project_arr = array('find','myb-img','jinglietou','hongzuan','lanjinger','lanjingshandong','lanjinghenan', 'lanjingapp');
    ...
    const OSS_DEFAULT_BUCKET = "geo-pic";
    const OSS_IMG_URL        = "http://img.tigerinsky.com/";
